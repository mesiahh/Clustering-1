...
# Check if the package loaded correctly
if(!exists("trial_sequence", mode="function")) {
  stop("TrialEmulation package not loaded correctly")
}
...
if (!dir.exists(trial_pp_dir)) dir.create(trial_pp_dir)

trial_itt_dir <- file.path(tempdir(), "trial_itt")
if (!dir.exists(trial_itt_dir)) dir.create(trial_itt_dir)
